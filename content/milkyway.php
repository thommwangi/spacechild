...
<header class="v-header container">
    ...
    <div class="navigation-wrapper">
      ...
      <video src="universe/milk.mp4" autoplay="" loop="" controls muted>
    </video>
    </div>
    <div class="header-overlay">
            <div class="header-content">
                <h1 style="color:white;font-size:10vw;">The Milkyway</h1>
                <p style="color:white;font-size:2vw;">There are over 100 billion stars in the Milky Way 
                galaxy. If you tried to count them one by one, it would take you over 3000 years!
                The Milky Way is over 100,000 light-years wide. It is called a spiral galaxy 
                because it has long arms which spin around like a giant pinwheel. Our Sun is a
                 star in one of the arms.
               ...
               <div class="modal" id="modal">  
                   ...
                   <h2 class="modal__heading">The Milkyway</h2>
                   <p class="modal__paragraph">When you look up at the night sky, most of the stars 
                       you see are in one of the Milky Way arms.
                        ...
                        it the Via Galactica, or "road made of milk". This is how our galaxy became known 
                        as the Milky Way.
                            </p>
                        </div>
                    </div>      
